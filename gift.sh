...
pandoc -f gfm -t html gift-list.md       -o gift-list.html
pandoc -f gfm -t html gift-list-heart.md -o gift-list-heart.html

pandoc -f gfm -t html README.md | sed 's/\.md"/.html"/g' > index.html
